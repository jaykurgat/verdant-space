...
import { LayoutDashboard, FileText, Image, Settings, LogOut, Leaf, Menu, X, ExternalLink } from 'lucide-react'
    ...
    <div className="min-h-screen bg-warm-white flex">
      ...
      `}>
        ...
        <div className="px-5 py-5 border-b border-warm-white/10 flex items-center gap-2.5">
          <div className="w-7 h-7 bg-sage/20 rounded-sm flex items-center justify-center flex-shrink-0">
